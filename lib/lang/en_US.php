<?php
/*
Pixmicat! & Yotsubanome language file - English (U.S.) [en_US]
*/
...
$language['notice_omitted_reply']				= ' omitted. Click [Reply] to view.';
...
$language['regist_withoutsubject']			= 'Please fill the title.';
$language['regist_withoutcomment']		= 'Please fill comment field if you don\'t upload an image.';
$language['regist_withoutpassword']			= 'Please fill your password.';
...
$language['form_noattechment']			= 'No File';
$language['form_contpost']				= 'Noko';
$language['form_category']				= 'Category';
$language['form_category_notice']		= '(Use , to seperate)';
$language['form_delete_password']		= 'Password';
$language['form_delete_password_notice']= '(Password used for post and file deletion, 8 chars max)';
$language['form_notice']				= '<li>Supported file types are: %1$s</li><li>Maximum file size allowed is %2$s KB. Fill E-mail with sage for not bumping post.</li><li>Images greater than %3$s * %4$s pixels will be thumbnailed.</li>';
...
$language['admin_stylesheets']		= 'Manage Stylesheets';
$language['admin_imported']		= 'Imported from <b>[file]</b>';
$language['admin_editing']		= 'Editing <b>[file]</b>';
$language['admin_created']		= '<b>[file]</b> created!';
$language['admin_updated']		= '<b>[file]</b> updated!';
$language['admin_deleted']		= '<b>[file]</b> deleted!';
// Headings for fields
$language['admin_is_default']		= 'Default?';
$language['admin_style_default']		= 'Make this default';
$language['admin_fullname']		= 'Full name';
$language['admin_shortname']		= 'Short name';
$language['admin_dispid']		= '<nobr>ID / Display order</nobr> <nobr>(0 to delete)</nobr>';
$language['admin_addstyle']		= 'Add [or modify] stylesheet entry';
// This goes in [or modify] above
$language['admin_modstyle']		= 'or modify';
$language['admin_new_file']		= 'File';
