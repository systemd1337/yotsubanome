<?php
/*
Pixmicat! & Yotsubanome language file - Japanese [ja_JP]
*/
...
$language['del_btn']					= ' 実行 ';
$language['prev_page']					= '前のページ'; // 前のﾍﾟｰｼﾞ
$language['first_page']					= '最初のページ'; // 最初のﾍﾟｰｼﾞ
$language['all_pages']					= 'すべて';
$language['next_page']					= '次のページ'; // 次のﾍﾟｰｼﾞ
$language['last_page']					= '最後のページ'; // 最後のﾍﾟｰｼﾞ
...
$language['notice_omitted_posts']				= 'レス [#] 投稿';
$language['notice_omitted_images']				= 'と [#] ファイル';
$language['notice_omitted_reply']				= '件省略。全て読むには[返信]ボタンを押してください。';
...
$language['regist_withoutsubject']			= '題名がありません';
$language['regist_withoutcomment']		= '何か書いて下さい';
$language['regist_withoutpassword']			= '削除キーが未入力です';
...
$language['info_basic_cr_limit']		= '改行を抑制する行数 (&lt;br&gt; check)';
$language['info_basic_cr_after']		= ' 行 (しない：0)';
//----$language['info_basic_timezone']		= '時間帯設定';
$language['info_basic_line_number_limit']		= '1レスに表示する行数';
$language['info_basic_line_number_after']		= ' 行 (しない：0)';
...
$language['form_notice']				= '<li>添付可能ファイル：%1$s<br />ブラウザによっては正常に添付できないことがあります。</li><li>最大投稿データ量は %2$s KBまで。sage機能付き。</li><li>画像は横 %3$s ピクセル、縦 %4$s ピクセルを超えると縮小表示されます。</li>';
...
$language['form_option1']			= '<span id="option">オプション1</span>';
$language['form_newt']		= '新スレッド';

$language['nothumb']		= '入手できないサムネイル';
$language['long_comment']		= '「省略されました・・全てを読むには';
$language['long_here']		= 'ここ';
$language['long_see']		= 'を押してください」';

$language['def_sub']		= '無題';
$language['def_name']		= '名無し';
$language['def_com']		= '本文なし';

// Style tooltip: stuff inside [square brackets] MUST be left as is!
$language['style_tooltip']		= 'スイッチは[what]スタイル';
// Title of stylesheet management page
$language['admin_stylesheets']		= 'スタイルシートを管理して';
$language['admin_imported']		= 'インポートから <b>[file]</b>';
$language['admin_editing']		= '編集 <b>[file]</b>';
$language['admin_created']		= '作成 <b>[file]</b>!';
$language['admin_updated']		= 'を更新 <b>[file]</b>!';
$language['admin_deleted']		= '削除 <b>[file]</b>!';
// Headings for fields
$language['admin_is_default']		= 'デフォルトのですか？';
$language['admin_style_default']		= 'このデフォルトにする';
$language['admin_fullname']		= '本当の名前';
$language['admin_shortname']		= '表示名前';
$language['admin_dispid']		= '<nobr>ID / 表示順</nobr> <nobr>(タイプ0この項目を削除する)</nobr>';
$language['admin_addstyle']		= '追加 [or modify] スタイルシートのエントリ';
// This goes in [or modify] above
$language['admin_modstyle']		= 'または変更';
$language['admin_new_file']		= 'ファイル';
$language['admin_new_id']		= '<nobr>表示順</nobr> <nobr>(既存のID番号を使用して、アイテムを上書きする)</nobr>';
if(!defined("PIXMICAT_LANGUAGE")) print_r($language);
?>
